  ...
  return (
    <div className={className} role="search">
      ...
      <input
        ...
        className="w-full rounded-md border border-border bg-background px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal/30"
        autoComplete="off"
      />
            ...
            {results.map((item) => (
              <li key={item.lessonId}>
                <button
                  ...
                  className="w-full rounded-md border border-border p-3 text-left hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal/30"
