...
/**
 * Minimal OAuth button — spec 05.3 only demands Google for MVP.
 * Marked as `type="button"` to avoid submitting the surrounding form
 * when the user triggers the OAuth flow before filling fields.
 */
