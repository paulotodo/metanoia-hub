...
export function NotificationBell({ onClick, open }: NotificationBellProps) {
  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center min-h-[44px] min-w-[44px] rounded-md hover:bg-[var(--accent)] focus:outline-none focus:ring-2 focus:ring-[var(--ring)] transition-colors"
    >
