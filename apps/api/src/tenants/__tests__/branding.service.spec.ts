...
/**
 * Valid PNG buffer (128×128 red) generated by sharp at suite setup.
 * Must be a real, parseable raster ≥ min dims (64×64) so uploadLogo's
 * sharp.metadata() + dimension validation succeed.
 */
