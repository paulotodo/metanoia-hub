...
- If detailed examples are required, open `resources/auth-implementation-playbook.md`.
...
- `resources/auth-implementation-playbook.md` for detailed patterns and examples.
