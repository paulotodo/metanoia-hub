...
- If detailed examples are required, open `resources/jc-implementation-playbook.md`.

## Resources

- `resources/jc-implementation-playbook.md` for detailed patterns and examples.
