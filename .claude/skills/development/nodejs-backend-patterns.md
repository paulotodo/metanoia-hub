...
- If detailed examples are required, open `resources/njs-implementation-playbook.md`.

## Resources

- `resources/njs-implementation-playbook.md` for detailed patterns and examples.
