...
Refer to `resources/api-implementation-playbook.md` for detailed patterns, checklists, and templates.

## Resources

- `resources/api-implementation-playbook.md` for detailed patterns, checklists, and templates.
